%-----------------------------------------------------------------------
% Job saved on 28-Nov-2016 16:37:01 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6685)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.meeg.source.invertiter.D = '<UNDEFINED>';
matlabbatch{1}.spm.meeg.source.invertiter.val = '<UNDEFINED>';
matlabbatch{1}.spm.meeg.source.invertiter.whatconditions.condlabel = {'Left_Long'};
matlabbatch{1}.spm.meeg.source.invertiter.isstandard.custom.invfunc = 'Classic';
matlabbatch{1}.spm.meeg.source.invertiter.isstandard.custom.invtype = 'IID';
...
matlabbatch{1}.spm.meeg.source.invertiter.isstandard.custom.isfixedpatch.fixedpatch.fixedfile = '<UNDEFINED>';
...
matlabbatch{1}.spm.meeg.source.invertiter.isstandard.custom.umodes = '';
